...
import play1 from "../assets/images/play-icon-black.png";
import play2 from "../assets/images/play-icon-white.png";
...
const Details = () => {
  ...
  console.log(newData);
  return (
    <Container style={{ backgroundImage: `url(${newData.backgroundImg})` }}>
      <ImageTitle>
